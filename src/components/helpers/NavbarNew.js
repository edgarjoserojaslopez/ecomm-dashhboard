  ...
  return (
    <nav className="bg-yellow-300 sm:flex w-full sm:justify-between sm:items-center sm:px-4 sm:py-2 fixed z-10">
      ...
      >
        <Link
          to="/login"
          className="mt-1 text-gray-500 bg-transparent border border-solid border-gray-500 hover:bg-gray-500 hover:text-white active:bg-pink-600 font-bold uppercase text-sm px-6 py-3 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
          type="button"
        >
          Iniciar sesión
        </Link>
